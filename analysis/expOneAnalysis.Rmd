...
```{r}
data<-read.table('exp1Res1125.csv',header=TRUE,sep=',')
...
# cohen.d(data[data$idpAgreement!=70,]$switchFraction, data[data$idpAgreement!=70,]$idpAgreement)
# cohen.d(data[data$idpAgreement!=70,]$agreementFraction, data[data$idpAgreement!=70,]$idpAgreement)

# cohen.d(data,"gender")
# cohen.d(c(high$switchFraction,low$switchFraction),f=c(rep("Treatment",,each=80),rep("control",each=108)))
cohen.d(switchFraction~idpAgreement,data=data)

# library(lsr)
# cohensD(data$idpAgreement,data$switchFraction)
# cohensD(data[data$idpAgreement!=70,]$switchFraction, data[data$idpAgreement!=70,]$idpAgreement)
```
